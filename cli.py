import argparse
from src.string_utils import slugify, generate_id, current_iso_utc
...
def main() -> None:
    ...
    # validate
    p_val = subparsers.add_parser("validate", help="Valida formatos comuns (cpf, email)")
    p_val.add_argument("type", choices=["cpf", "email"], help="Tipo de validacao")
